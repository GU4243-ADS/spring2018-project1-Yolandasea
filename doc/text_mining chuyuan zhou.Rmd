...
Can we use this to visualize which authors use which topics more than others?  Is twelve topics the correct number?  Should sentences be the correct 'unit' here or should we do a topic analysis on three documents consisting on the corpus of each author's texts?
